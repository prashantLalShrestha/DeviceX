...
public enum DeviceConnectivity: String {
    case unknown        = "Unknown"
    case wiFi           = "WiFi"
    case wiFi3G         = "WiFi + 3G"
    case wiFi4G         = "WiFi + 4G"
...
public struct DeviceX {
    ...
    public fileprivate (set) var type: DeviceType
    ...
    public fileprivate (set) var size: DeviceSize
    /// The connectivity of the device (DeviiceConnectivity)
    public fileprivate (set) var connectivity: DeviceConnectivity
...
extension DeviceX: CustomStringConvertible {
